...
<section class="landing-section landing-section--intro">
  <div class="landing-section__inner">
    ...
    <p class="landing-section__subtitle" style="font-size: 1.3em; margin-top: 1.5rem; color: #e0e0e0;">
      Featuring <span style="color: #ffb300; font-weight: 700; font-size: 1.2em;">137 expert guides</span> and <span style="color: #ff6b6b; font-weight: 700; font-size: 1.2em;">523 themed builds</span> crafted by <span style="color: #b794f6; font-weight: 700; font-size: 1.2em;">6 amazing contributors</span>
    </p>
  </div>
</section>
    ...
    <div class="guide-cards">
      ...
      <a href="grimreaper/" class="guide-card-link">
        <div class="guide-card">
          ...
          <p class="guide-card-desc">Creative collection: 523 themed builds inspired by pop culture, mythology, and legends. Fun, roleplay-focused strategies—not meta builds.</p>
        </div>
      </a>
      ...
      <a href="shins/" class="guide-card-link">
        <div class="guide-card">
          ...
          <p class="guide-card-desc">Massive collection: 98 guides covering mechanics, all 53 melee weapons, and all 35 armor sets. Complete system analysis with data-driven insights.</p>
        </div>
      </a>
...
<section class="landing-section landing-section--quickstart">
  <div class="landing-section__inner">
    ...
    <div class="quickstart-grid">
      ...
      <div class="quickstart-item">
        <h3>🎭 Themed Builds</h3>
        <p><a href="grimreaper/">GrimReaper's Guides</a> feature creative themed builds inspired by pop culture, mythology, and legends—fun and roleplay-focused, not meta.</p>
      </div>
    </div>
  </div>
</section>
