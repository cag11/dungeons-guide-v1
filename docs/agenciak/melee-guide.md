...
### ![Double Axe](../assets/melee/Double_Axe_(MCD).webp){ width="24" } Double Axe, ![Whirlwind](../assets/melee/Whirlwind_(MCD).webp){ width="24" } Whirlwind
...
### ![Starless Night](../assets/melee/The_Starless_Night_(MCD).webp){ width="24" } Starless Night
*5th highest DPS in the game, big area and has* ![Shared Pain](../assets/enhancements/Shared_Pain.webp){ width="24" } *Shared Pain built in*

![Voidstrike](../assets/enhancements/Void_Strike.webp){ width="24" } + ![Unchanting](../assets/enhancements/Unchanting.webp){ width="24" } + ![Guarding Strike](../assets/enhancements/Guarding_Strike_(MCD_Enchantment).webp){ width="24" } + ![Weakening](../assets/enhancements/Weakening.webp){ width="24" } (Only with lifesteal)

![Voidstrike](../assets/enhancements/Void_Strike.webp){ width="24" } + ![Unchanting](../assets/enhancements/Unchanting.webp){ width="24" } + ![Guarding Strike](../assets/enhancements/Guarding_Strike_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" }

### ![Obsidian Claymore](../assets/melee/Obsidian_Claymore_(MCD).webp){ width="24" } Obsidian Claymore
...
### ![Wither Armor](../assets/armor/Wither_Armor_(MCD).webp){ width="24" } Wither Armor

- Lifesteal aura (heals you for 6% of your weapon's direct damage (so enchants like ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } Shockwave, ![Swirling](../assets/enhancements/T_Swirling_Icon.webp){ width="24" } Swirling or ![Thundering](../assets/enhancements/Thundering.webp){ width="24" } Thundering don't fuel it, if you're using lifesteal armor, these are the enchants you want to avoid, also it's an **aura**, meaning that your allies also benefit from it)
- +35% Damage reduction

### ![Spider Armor](../assets/armor/Spider_Armor_(MCD).webp){ width="24" } Spider Armor

- Lifesteal aura
- +25% faster attack speed

### ![Renegade Armor](../assets/armor/Renegade_Armor_(MCD).webp){ width="24" } Renegade Armor
...
![Cooldown](../assets/enhancements/Cool_Down.webp){ width="24" } **Cooldown** - **mandatory**, allows for infinite deathcap mushroom and iron hide amulet at high power levels

![Potion Barrier](../assets/enhancements/Potion_Barrier.webp){ width="24" } **Potion barrier** - **very good**, gives you 90% DR for 9 seconds every time your health potion is used, very strong when paired with ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } Refreshment

![Deflecting](../assets/enhancements/Deflect.webp){ width="24" } **Deflecting** - **very good**, has a 45% to block 100% damage from incoming projectiles and deflect them to their source

![Chilling](../assets/enhancements/Chilling.webp){ width="24" } **Chilling** - **very good**, slows enemies (Triggers every 2 seconds)

![Snowball](../assets/enhancements/Snowball_(Dungeons).webp){ width="24" } **Snowball** - **very good**, stuns one enemy for 1 second every second (it can save you in close meetings with creepers)

![Death Barter](../assets/enhancements/Death_Barter.webp){ width="24" } **Death barter** - **good**, allows you to respawn with 100% health, the downside of it is that discards everything you earned during the mission, it's not the best possible option for builds focusing on not dying at all (melee/tank builds)

![Cowardice](../assets/enhancements/Cowardice.webp){ width="24" } **Cowardice** - **good**, if you have full HP, you deal 40% more damage, melee builds take a lot of damage but with solid healing it's a good DPS booster
...
Your ranged weapon doesn't really matter in melee builds, you could preferably use a one-shot bow (elite power bow with enchants like ![Overcharge](../assets/enhancements/Over-Charge_(MCD_Enchantment).webp){ width="24" } + ![Supercharge](../assets/enhancements/Supercharge.webp){ width="24" } + ![Growing](../assets/enhancements/Growing.webp){ width="24" }) to easily clear out stronger enemies or an imploding crossbow with ![Refreshment](../assets/enhancements/Refreshment_Ranged_(MCD_Enchantment).webp){ width="24" } Refreshment to utilise potion enchants like barrier more effectively
