...
The HPS of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } is as follows:

Base: 19
+ **MAS 2.10**
+ ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" }: 3.4
+ **MAX: MAS 3.35**

The HPS of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } is as follows:

Base: 19
+ **MAS: 2.30**
+ ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" }: 3.82
+ **MAX: MAS 4.02**

The base dps of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } is **1,050,418k**.

- The + ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } dps of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } is **4,468,014k**
- The + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } dps at MAX dps is **6,910,944k**

The base dps of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } is **1,305,476k**.

- The + ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } dps of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } is **4,468,014k**
- The + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } dps of ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } is **8,936,028k**

---

## 🗺️ Locations you can obtain ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" }:

- Creeper Woods (Apoc/Apoc+, ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CI)
- Squid Coast (Apoc/Apoc+, ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CI)
- Overgrown Temple (Apoc/Apoc+, ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CI)
- Colossal Rampart (Apoc/Apoc+, ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CII)
- Fiery Forge (Apoc/Apoc+, ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CII)
- Broken Citadel (![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CI)
- Nether (![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CII)
- Gauntlet Of Gales (![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CIII)
- Gift Wrapper (from another player)
- Ancient Hunt (any ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } CII)
- Myriad Hunt (melee base)
- Tower (any Ancient Golem base ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } without ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" })

---

## 🎯 For use with ![Deflect](../assets/enhancements/Deflect.webp){ width="24" } can use ![Deflect](../assets/enhancements/Deflect.webp){ width="24" } on the armor with ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } if you want.

### Best enchantments:

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Fire Aspect](../assets/enhancements/Fire_Aspect.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Fire Aspect](../assets/enhancements/Fire_Aspect.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" }
...
- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Fire Aspect](../assets/enhancements/Fire_Aspect.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Poison Cloud](../assets/enhancements/Poison_Cloud.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" }

- ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Leeching](../assets/enhancements/Leeching.webp){ width="24" } + ![Fire Aspect](../assets/enhancements/Fire_Aspect.webp){ width="24" } + ![Rushdown](../assets/enhancements/Rushdown.webp){ width="24" }

- ![Shockwave](../assets/enhancements/Shockwave.webp){ width="24" } + ![Refreshment](../assets/enhancements/Refreshment_Melee_(MCD_Enchantment).webp){ width="24" } + ![Critical Hit](../assets/enhancements/Critical_Hit.webp){ width="24" } + ![Fire Aspect](../assets/enhancements/Fire_Aspect.webp){ width="24" }
...
## 🎯 With subzero on the armor with ![Mushroom](../assets/artifacts/Tasty_Bone_(MCD).webp){ width="24" } if you want.
